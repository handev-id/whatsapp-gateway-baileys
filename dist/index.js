...
const generativeAi_1 = require("./utils/generativeAi");
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        sock.ev.on("messages.upsert", (m) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (!message.key.fromMe) {
                ...
                const receivedMessage = ((_a = message.message) === null || _a === void 0 ? void 0 : _a.conversation) || "";
                const response = yield (0, generativeAi_1.generativeAi)(receivedMessage);
                // Kirim balasan otomatis
                yield sock.sendMessage(remoteJid, {
                    text: response,
                });
